...
<body>
    ...
    <div class="container">
        ...
        <form id="resetForm">
            ...
            <input type="password" class="password-input" placeholder="Confirm new password" required>
    ...
    <script>
        document.getElementById('resetForm').addEventListener('submit', function (event) {
            ...
            changeButton.innerHTML = "Changing...";
            changeButton.disabled = true;

            // Simulate password change (this could be an actual API call)
            setTimeout(function () {
            ...
            }, 2000); // 2 seconds delay (simulated password change time)
        });
        ...
        }, 1000); // 3 seconds before hiding the pop-up
    </script>
